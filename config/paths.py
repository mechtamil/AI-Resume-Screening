...
# User-private storage roots. Files below these roots are always partitioned by
# tenant, user and screening workspace. Legacy shared upload paths above remain
# only for compatibility with older non-production code.
PRIVATE_UPLOADS_DIR = UPLOADS_DIR / "private"
PRIVATE_TEMP_DIR = TEMP_DIR / "private"
PRIVATE_OUTPUT_DIR = OUTPUT_DIR / "private"
PRIVATE_CONFIGURATIONS_DIR = MASTER_DATA_DIR / "private"
